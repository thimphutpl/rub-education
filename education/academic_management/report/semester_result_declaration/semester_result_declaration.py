...
def get_columns(filters=None):
    ...
    if filters.get("student_section"):
        conditions.append("student_section = %(student_section)s")
        values["student_section"] = filters.get("student_section")
    ...
    for idx in data:
        columns.append({
            "label": idx.module,
            "fieldname": idx.module.replace(" ", "_").lower(),
            "fieldtype": "HTML",   # ✅ must be HTML
            "width": 200
        })
